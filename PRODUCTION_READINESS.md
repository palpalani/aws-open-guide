...
Configure once in **Settings → Branches → Branch protection rules** for `main`:

- [ ] Require a pull request before merging
- [ ] Require status check **Check Markdown links** (from [link-check.yml](.github/workflows/link-check.yml))
- [ ] Require review from Code Owners (optional; requires [.github/CODEOWNERS](.github/CODEOWNERS) and branch protection enabled)
